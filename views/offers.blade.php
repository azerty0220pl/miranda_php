...
@section('content')
    ...
    <?php 
                while($row = $rooms->fetch_assoc()) {
                    ...
                    if($row['room_type'] == 0)
                        $temp_type = 'SINGLE BED';
                    else if($row['room_type'] == 1)
                        $temp_type =  'DOUBLE BED';
                    else if($row['room_type'] == 2)
                        $temp_type =  'DOUBLE SUPERIOR';
                    ...
                    echo 
                        ...
                        <div class="offer_content">
                            <div class="prices">
                                ...
                                <p class="price-1 text--color-red text--align-end">$' . (string)($row["price"] * (1 - $row["offer"] / 100) / 100) . '<span
                                        class="paragraph-2 text--color-red">/Night</span></p>
                            </div>
                            <div class="titles">
                                <p class="title-up text--color-grey-3">' . $temp_type . '</p>
        ...
        <div class="even-row">
            <?php
                if($page == 0)
                    ...
                    echo '<a href="/offers.php?page=' . $page - 1 . '">';
            ?>
            ...
            <?php
                ...
                for ($i = 1; $i <= $pages; $i++) {
                    if ($i - 1 != $page)
                        echo '<a href="/offers.php?page=' . $i - 1 . '" class="pagination-text">' . $i . '</a>';
                    else 
                        echo '<a href="/offers.php?page=' . $i - 1 . '" class="pagination-selected">' . $i . '</a>';
                }
            ?>
            <?php
                $pages = ceil($count / 9);
