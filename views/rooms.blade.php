...
@section('content')
    ...
    @section('home')
    @section('welcome', 'Ultimate Rooms')
    @parent
    <section class="rooms">
        <div class="list">
            <div class="room">
                ...
                <div class="room-content">
                    ...
                    <div class="even-row">
                        <p class="price-2 text--color-gold text--align-center">$345/Night</p>
                        <p class="price-2 text--color-grey-2 text--align-center">Book Now</p>
                    </div>
                </div>
            </div>
            <div class="room">
